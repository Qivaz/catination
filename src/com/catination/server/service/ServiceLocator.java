...
public class ServiceLocator {
    ...
    public static String ROSTER_SERVICE = "rosterService";
    ...
    /**
     * Obtains the roster service.
     * 
     * @return the roster service
     */
    public static RosterService getRosterService() {
        return (RosterService) XmppServer.getInstance().getBean(ROSTER_SERVICE);
    }
