 ...
 */
public class XmlProtocolCodecFilter extends IoFilterAdapter {
    /** A logger for this class */
    private static final Logger LOGGER = LoggerFactory.getLogger(XmlProtocolCodecFilter.class);

    private static final Class<?>[] EMPTY_PARAMS = new Class[0];

    private static final IoBuffer EMPTY_BUFFER = IoBuffer.wrap(new byte[0]);

    private static final AttributeKey ENCODER = new AttributeKey(XmlProtocolCodecFilter.class, "xmlEncoder");
    private static final AttributeKey DECODER = new AttributeKey(XmlProtocolCodecFilter.class, "xmlDecoder");
    private static final AttributeKey ENCODER_OUT = new AttributeKey(XmlProtocolCodecFilter.class, "xmlEncoderOut");
    private static final AttributeKey DECODER_OUT = new AttributeKey(XmlProtocolCodecFilter.class, "xmlDecoderOut");
    ...
    /**
     * Creates a new instance of XmlProtocolCodecFilter, associating a factory
     * for the creation of the encoder and decoder.
     *
     * @param factory The associated factory
     */
    public XmlProtocolCodecFilter(ProtocolCodecFactory factory) {
        if (factory == null) {
    ...
    /**
     * Creates a new instance of XmlProtocolCodecFilter, without any factory.
     ...
     */
    public XmlProtocolCodecFilter(final ProtocolEncoder encoder, final ProtocolDecoder decoder) {
        if (encoder == null) {
     ...
     */
    public XmlProtocolCodecFilter(final Class<? extends ProtocolEncoder> encoderClass,
    ...
    public void messageReceived(NextFilter nextFilter, IoSession session, Object message) throws Exception {
        LOGGER.debug("<XML>Processing a MESSAGE_RECEIVED for session {}", session.getId());
    ...
    //@Override
    //public String toString() {
    //    return "XmlProtocolCodecFilter" + "/"+ XmlProtocolCodecFilter.this + ", " + super.toString();
    //}
}
