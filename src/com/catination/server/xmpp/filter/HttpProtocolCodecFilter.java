 ...
 */
public class HttpProtocolCodecFilter extends IoFilterAdapter {
    /** A logger for this class */
    private static final Logger LOGGER = LoggerFactory.getLogger(HttpProtocolCodecFilter.class);

    private static final Class<?>[] EMPTY_PARAMS = new Class[0];

    private static final IoBuffer EMPTY_BUFFER = IoBuffer.wrap(new byte[0]);

    private static final AttributeKey ENCODER = new AttributeKey(HttpProtocolCodecFilter.class, "httpEncoder");
    private static final AttributeKey DECODER = new AttributeKey(HttpProtocolCodecFilter.class, "httpDecoder");
    private static final AttributeKey ENCODER_OUT = new AttributeKey(HttpProtocolCodecFilter.class, "httpEncoderOut");
    private static final AttributeKey DECODER_OUT = new AttributeKey(HttpProtocolCodecFilter.class, "httpDecoderOut");
     ...
     */
    public HttpProtocolCodecFilter(final ProtocolEncoder encoder, final ProtocolDecoder decoder) {
        if (encoder == null) {
     ...
     */
    public HttpProtocolCodecFilter(final Class<? extends ProtocolEncoder> encoderClass,
    ...
    public void messageReceived(NextFilter nextFilter, IoSession session, Object message) throws Exception {
        LOGGER.debug("<HTTP>Processing a MESSAGE_RECEIVED for session {}", session.getId());
    ...
    //@Override
    //public String toString() {
    //    return HttpProtocolCodecFilter.class.getSimpleName() + "/"+ HttpProtocolCodecFilter.this + ", " + super.toString();
    //}
}
