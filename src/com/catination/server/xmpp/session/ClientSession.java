...
public class ClientSession extends Session {
    ...
    public static ClientSession createSession(String serverName,
            ...
            throws XmlPullParserException, UnknownHostException {
     ...
     * @throws UnknownHostException 
     */
    public void setAuthToken(AuthToken authToken, String resource) throws UnknownHostException {
    ...
    public static final class Location {
    	...
    	public Location(boolean isCdma, int l1, int l2) {
    		if (isCdma) {
    			cdma = true;
    			sid = l1;
    			nid = l2;
