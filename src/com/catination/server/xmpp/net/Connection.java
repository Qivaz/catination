...
import com.catination.server.xmpp.ssl.SSLConfig;
import com.catination.server.xmpp.ssl.SSLKeyManagerFactory;
import com.catination.server.xmpp.ssl.SSLTrustManagerFactory;
...
public class Connection {
    ...
    public void startTLS(ClientAuth authentication) throws Exception {
        log.debug("Connection.startTLS()...");
        KeyStore ksKeys = SSLConfig.getKeyStore();
        log.debug("Connection.startTLS(), ksKeys="+ksKeys);
        String keypass = SSLConfig.getKeyPassword();
        
        log.debug("Connection.startTLS(), ksKeys="+ksKeys+", keypass="+keypass);

        KeyStore ksTrust = SSLConfig.getc2sTrustStore();
        String trustpass = SSLConfig.getc2sTrustPassword();
        
        log.debug("Connection.startTLS(), ksTrust="+ksTrust+", trustpass="+trustpass);
        ...
        log.debug("Connection.startTLS(), km[]="+km+", tm[]="+tm);
        ...
        log.debug("Connection.startTLS(), tlsContext="+tlsContext+", filter="+filter);
