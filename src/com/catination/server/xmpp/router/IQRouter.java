...
import com.catination.server.xmpp.handler.IQFileTransferHandler;
import com.catination.server.xmpp.handler.IQHandler;
import com.catination.server.xmpp.handler.IQProfilesHandler;
...
public class IQRouter {
    ...
    public IQRouter() {
        ...
        iqHandlers.add(new IQProfilesHandler());
        iqHandlers.add(new IQFileTransferHandler());
    }
    ...
    private void handle(IQ packet) {
        try {
            ...
            log.info("handle(), namespace="+namespace);
            if (namespace == null) {
    ...
    public void addHandler(IQHandler handler) {
        ...
        log.info("addHandler(), namespace="+handler.getNamespace());
    ...
    private IQHandler getHandler(String namespace) {
    	log.info("getHandler(), namespace="+namespace);
