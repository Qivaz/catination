...
public abstract class Packet {
    ...
    public MsgFile getMsgFile() {
        ...
        String size = file.attributeValue("size");
        String hash = file.attributeValue("hash");
        String type = file.attributeValue("content-type");
        MsgFile mf = new MsgFile(this.getFrom().toString(), this.getTo().toString(), name, size, hash, type);
    ...
    public static class MsgFile {
    	/*
		<message id="vXqUN-4" to="test2@catination.com" from="test2@catination.com/SC" type="file">
		  <thread>3lLV80</thread>
		  <file name="ADVERTISEMENT_ORIG_PIC_2.jpg"
		        size="129844"
		        hash="1989791909"
		...
		*/
        ...
        public MsgFile(String from, String to, String name, String size, String hash, String type) {
        	if (from == null) {
        ...
        /**
         * Returns the sender of this file.
         *
         * @return the sender of this file.
         */
        ...
        /**
         * Returns the recipient of this file.
         *
         * @return the recipient of this file.
         */
        public String getTo() {
            return to;
        }
