...
<table id="tableList" class="tablesorter" cellspacing="1">
	...
	<tbody>
		<c:forEach var="user" items="${userList}">
			<tr>
				<td id="${user.username}" align="center">
				<a href="notification/form.jsp?user=${user.username}">
				<!-- a href="notification.do?user=${user.username}" -->
				<c:choose>
...
$(function() {
	...
	//$('td[id=test1]').click(function() {
		//console.log("clickUser()");
		//alert("clickUser()");
		//<%         
		//	response.sendRedirect("redirect:notification.do");
		//%>
