...
<%
   ...
   System.out.println("Request to notify user="+user);
   if (user == null) {
   		user="";
   }
%>
...
<tr>
	<td width="20%">To:</td>
	<td width="80%">
		<input type="radio" name="broadcast" value="Y" />  All (Broadcast) 
        <input type="radio" name="broadcast" value="N" checked="checked"/> Single Device 
	</td>
</tr>
<tr id="trUsername" style="display:none;">
	<td>Username:</td>
	<td><input type="text" id="username" name="username" value="<%=user%>" style="width:380px;" /></td>
</tr>
<tr>
	<td>Title:</td>
...
<tr>
	...
	<td><input type="text" id="uri" name="uri" value="" style="width:380px;" />
	    <br/><span style="font-size:0.8em">ex) http://www.catination.com</span>
	</td>
</tr>
<tr>
	<td>&nbsp;</td>
